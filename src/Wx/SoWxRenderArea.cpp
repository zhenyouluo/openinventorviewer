...
SoKeyboardEvent::Key SoWxRenderArea::translateKey( wxKeyEvent& e )
{
    ...
    case WXK_CAPITAL:   event = SoKeyboardEvent::CAPS_LOCK; break;
    case WXK_END:       event = SoKeyboardEvent::END; break;
    case WXK_HOME:      event = SoKeyboardEvent::HOME; break;
    case WXK_LEFT:      event = SoKeyboardEvent::LEFT_ARROW; break;
    case WXK_UP:        event = SoKeyboardEvent::UP_ARROW; break;
    case WXK_RIGHT:     event = SoKeyboardEvent::RIGHT_ARROW; break;
    case WXK_DOWN:      event = SoKeyboardEvent::DOWN_ARROW; break;
    case WXK_SELECT: break;
    case WXK_PRINT:     event = SoKeyboardEvent::PRINT; break;
    ...
    case WXK_F23: break;
    case WXK_F24: break;
    case WXK_NUMLOCK:   event = SoKeyboardEvent::NUM_LOCK; break;
    case WXK_SCROLL:    event = SoKeyboardEvent::SCROLL_LOCK; break;
    case WXK_PAGEUP:    event = SoKeyboardEvent::PAGE_UP; break;
    case WXK_PAGEDOWN:  event = SoKeyboardEvent::PAGE_DOWN; break;
